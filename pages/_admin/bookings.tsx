...
const mockRows: BookingRow[] = [
  { id: 'BK-2112', user: 'Olivia Wilde', email: 'olivia@carento.com', car: 'Tesla Model 3', status: 'CONFIRMED', payment: 'PAID', amount: 180, createdAt: '2025-12-25' },
  { id: 'BK-2111', user: 'James Park', email: 'james@carento.com', car: 'BMW M4', status: 'PENDING', payment: 'PENDING', amount: 240, createdAt: '2025-12-24' },
  { id: 'BK-2110', user: 'Sara Lee', email: 'sara@carento.com', car: 'Audi A6', status: 'CANCELLED', payment: 'REFUNDED', amount: 130, createdAt: '2025-12-24' },
  { id: 'BK-2109', user: 'Daniel Cho', email: 'daniel@carento.com', car: 'Hyundai Ioniq', status: 'CONFIRMED', payment: 'PAID', amount: 95, createdAt: '2025-12-23' },
  { id: 'BK-2108', user: 'Emily Carter', email: 'emily@carento.com', car: 'Mercedes E-Class', status: 'PENDING', payment: 'PENDING', amount: 310, createdAt: '2025-12-23' },
];
...
const AdminBookingsPage = () => {
  ...
  return (
    <>
      ...
      <AdminShell title="Bookings" subtitle="Manage bookings, statuses, and payments" range={range} onRangeChange={setRange} activePath="/_admin/bookings">
        <div style={styles.page}>
          ...
          <div style={styles.topBar}>
            <div style={styles.topLeft}>
              ...
              <p style={styles.sub}>
                {rangeLabel} • Search, filter, and review booking activity
              </p>
            </div>
            ...
            <div style={styles.topRight}>
              ...
              <button
                ...
                onClick={() => pretendAction('Export CSV')}
              >
                Export
              </button>
            </div>
          ...
          <div style={styles.statsRow}>
            ...
            <div style={styles.stat}>
              ...
              <span style={{ ...styles.statChip, background: 'rgba(79,139,255,.12)', borderColor: 'rgba(79,139,255,.22)', color: '#1d4ed8' }}>CONFIRMED</span>
            </div>
            ...
            <div style={styles.stat}>
              ...
              <span style={{ ...styles.statChip, background: 'rgba(245,158,11,.12)', borderColor: 'rgba(245,158,11,.22)', color: '#92400e' }}>PENDING</span>
            </div>
            ...
            <div style={styles.stat}>
              ...
              <span style={{ ...styles.statChip, background: 'rgba(34,197,94,.12)', borderColor: 'rgba(34,197,94,.22)', color: '#166534' }}>PAID</span>
            </div>
          </div>
            ...
            <div style={styles.cardBody}>
              <div style={styles.filters}>
                ...
                <div style={{ ...styles.field, ...styles.col2 }}>
                  ...
                  <input style={styles.input} inputMode="numeric" placeholder="0" value={minAmount} onChange={(e) => setMinAmount(e.target.value)} />
                </div>

                <div style={{ ...styles.field, ...styles.col2 }}>
                  <div style={styles.label}>Max $</div>
                  <input style={styles.input} inputMode="numeric" placeholder="9999" value={maxAmount} onChange={(e) => setMaxAmount(e.target.value)} />
                </div>

                <div style={{ ...styles.col12, display: 'flex', justifyContent: 'flex-end', gap: 10, flexWrap: 'wrap' }}>
                  ...
                  <button
                    type="button"
                    style={styles.btnPrimary}
                    onClick={() => pretendAction('Apply (demo)')}
                  >
                    Apply
                  </button>
                </div>
                      ...
                      <td style={{ ...styles.td, ...styles.actionCell }}>
                        ...
                        {menuId === row.id && (
                          <div style={styles.menu}>
                            ...
                            <div style={{ ...styles.menuItem, ...styles.menuItemDanger }} onClick={() => pretendAction(`Cancel ${row.id}`)}>
                              Cancel booking
                            </div>
                          </div>
                        )}
              ...
              <div style={styles.modal}>
                ...
                <div style={styles.modalBody}>
                  <div style={styles.kv}>
                    ...
                    <div style={{ ...styles.v, color: '#667085', fontWeight: 850, fontSize: 12.5 }}>{selected.email}</div>
                  </div>
                ...
                <div style={styles.modalFoot}>
                  <button type="button" style={styles.btnGhost} onClick={() => pretendAction(`Message user (${selected.email})`)}>
                    Message user
                  </button>
                  <button type="button" style={styles.btnPrimary} onClick={() => pretendAction(`Confirm ${selected.id}`)}>
                    Confirm
                  </button>
